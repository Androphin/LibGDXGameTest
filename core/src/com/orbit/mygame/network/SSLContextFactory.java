...
public class SSLContextFactory {
    ...
    public SSLContext makeContext() throws Exception{
        ...
        //webserver certificate chainorder response is: Server -> Intermediate -> Root
        //Certificate order: Root -> Intermediate [-> Server]
        FileHandle caFile = new FileHandle("CAchain.crt");
